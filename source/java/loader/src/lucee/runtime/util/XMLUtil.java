...
public interface XMLUtil {
	 ...
	 */
	public Object getProperty(Node node, Key k, boolean caseSensitive,
			Object defaultValue);
     ...
     */
	public Object removeProperty(Node node, Key k, boolean caseSensitive);
	 ...
	 */public ArrayList<Node> getChildNodes(Node node, short type, boolean caseSensitive, String filter);
     ...
     * @throws IOException
     */
	public String transform(InputSource xml, InputSource xsl, Map<String,Object> parameters)
     ...
     * @throws IOException
     */
	public String transform(Document doc, InputSource xsl, Map<String,Object> parameters)
			throws TransformerException;
