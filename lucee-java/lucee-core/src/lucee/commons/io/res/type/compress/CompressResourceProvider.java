...
public abstract class CompressResourceProvider implements ResourceProviderPro,Sizeable {
	...
	/*public static void main(String[] args) throws IOException {
		...
		Resource luceetmp = rs.getResource("/Users/mic/temp/luceetmp/");
		Resource trg2 = rs.getResource("zip:///Users/mic/temp/luceetmp.zip!");
		trg2.delete();
		long start=System.currentTimeMillis();
		ResourceUtil.copyRecursive(luceetmp, trg2);
