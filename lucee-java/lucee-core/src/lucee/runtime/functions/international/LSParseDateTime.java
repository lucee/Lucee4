...
public final class LSParseDateTime implements Function {
	...
	public static lucee.runtime.type.dt.DateTime call(PageContext pc , Object oDate,String strLocale) throws PageException {
		return _call(pc, oDate, LocaleFactory.getLocale(strLocale),pc.getTimeZone(),null);
	}
	
	public static lucee.runtime.type.dt.DateTime call(PageContext pc , Object oDate,String strLocale,String strTimezoneOrFormat) throws PageException {
	...
	public static lucee.runtime.type.dt.DateTime call(PageContext pc , Object oDate,String strLocale,String strTimezone, String strFormat) throws PageException {
