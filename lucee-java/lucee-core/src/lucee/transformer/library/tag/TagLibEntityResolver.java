...
public final class TagLibEntityResolver implements EntityResolver {
	...
	//public final static String SUN_DTD_1_0=	"/resource/dtd/web-jsptaglibrary_1_0";
	...
	public InputSource resolveEntity(String publicId, String systemId) {
		...
		if ( publicId.equals( "-//Lucee//DTD CFML Tag Library 1.0//EN" ) 
				|| publicId.equals( "-//Railo//DTD CFML Tag Library 1.0//EN" )) {
