...
public final class CFMLTransformer {
	...
	public Page transform(ConfigImpl config,CFMLString cfml,TagLib[] tlibs,FunctionLib[] flibs, long sourceLastModified, Boolean dotNotationUpperCase) throws TemplateException {
		...
		Page page=new Page(source,source.getPhyscalFile(),source.getFullClassName(),Info.getFullVersionInfo(),sourceLastModified,cfml.getWriteLog(),config.getSuppressWSBeforeArg(),config.getDefaultFunctionOutput());
...
//		TODO muss erlaubt sein
     ...
     * @param tag Definition des Tag das dieses Attribut enthuelt.
