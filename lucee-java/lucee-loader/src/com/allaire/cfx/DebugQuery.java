...
public final class DebugQuery extends QueryWrap {
	...
	private static lucee.runtime.type.Query toQuery(String name, String[] columns, String[][] data) {
	...
	private static lucee.runtime.type.Query toQuery(String name, String[] columns, int rows) {
