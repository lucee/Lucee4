...
<cfset driverNames=ComponentListPackageAsStruct("lucee-server-context.admin.cdriver",driverNames)>
<cfset driverNames=ComponentListPackageAsStruct("lucee-context.admin.cdriver",driverNames)>
