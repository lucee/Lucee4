...
<cfset driverNames=ComponentListPackageAsStruct("lucee-server-context.admin.dbdriver",driverNames)>
<cfset driverNames=ComponentListPackageAsStruct("lucee-context.admin.dbdriver",driverNames)>
