...
<cfset names=ComponentListPackageAsStruct("lucee-server-context.admin.logging.appender",names)>
<cfset names=ComponentListPackageAsStruct("lucee-context.admin.logging.appender",names)>
...
<cfset layouts={}>
<cfset names=structnew("linked")>
<cfset names=ComponentListPackageAsStruct("lucee-server-context.admin.logging.layout",names)>
<cfset names=ComponentListPackageAsStruct("lucee-context.admin.logging.layout",names)>
