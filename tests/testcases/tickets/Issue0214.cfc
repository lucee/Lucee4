...
component extends="org.lucee.cfml.test.LuceeTestCase"	{
	...
	public void function testNoHTML(){
		http method="get" result="local.result" url="#createURL("Issue0214/noHTML.cfm")#" addtoken="false";
		assertEquals("For-HeaderHello World",result.filecontent.trim());
	}

	public void function testNoHead(){
		http method="get" result="local.result" url="#createURL("Issue0214/noHead.cfm")#" addtoken="false";
		assertEquals("For-Header<html>Hello World</html>",result.filecontent.trim());
	}

	public void function testWithHead(){
		http method="get" result="local.result" url="#createURL("Issue0214/withHead.cfm")#" addtoken="false";
